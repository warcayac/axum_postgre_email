...
pub async fn send_verification_email(to_email: &str, username: &str, token: &str) -> TVoidResult {
...
pub async fn send_welcome_email(to_email: &str, username: &str) -> TVoidResult {
...
pub async fn send_forgot_password_email(to_email: &str, rest_link: &str, username: &str) -> TVoidResult {
