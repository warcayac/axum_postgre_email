...
use crate::{db::user_ext::UserExt, errors::{error_message::ErrorMessage, http_error::HttpError}, mail::mails::{send_forgot_password_email, send_verification_email, send_welcome_email}, models::dtos::{forgot_password_request::ForgotPasswordRequestDto, login_user::LoginUserDto, register_user::RegisterUserDto, reset_password_request::ResetPasswordRequestDto, response::Response, user_login_response::UserLoginResponseDto, verify_email_query::VerifyEmailQueryDto}, utils::{password, token}, AppState};
...
pub async fn login(
    ...
    if password_matched {
        ...
        let cookie_duration = time::Duration::minutes(app_state.env.jwt_max_age * 60);
